...
$page_title = "415 - Unsupported Media Type";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 415 - Unsupported Media Type</h1>
                        <p class='errText'>Looks like you've gone a little off course! Your request has a media type which the server does not support.</p>

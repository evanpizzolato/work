...
$page_title = "426 - Upgrade Required";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 426 - Upgrade Required</h1>
                        <p class='errText'>Looks like you've gone a little off course! Your request failed because your protocol in the Upgrade header field was invalid.</p>

...
$page_title = "411 - Length Required";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 411 - Gone</h1>
                        <p class='errText'>Looks like you've gone a little off course! Your request did not specify the length of the content, which is required to access this resource.</p>

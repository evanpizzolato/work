...
$page_title = "407 - Proxy Authentication Required";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 407 - Proxy Authentication Required</h1>
                        <p class='errText'>Looks like you've gone a little off course! Proxy authentication is required to access this resource.</p>

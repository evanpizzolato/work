...
$page_title = "421 - Misdirected Request";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 421 - Misdirected Request</h1>
                        <p class='errText'>Looks like you've gone a little off course! Your request was directed at a server that cannot produce a response.</p>

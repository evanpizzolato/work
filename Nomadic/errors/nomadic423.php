            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 423 - Locked</h1>
                        <p class='errText'>Looks like you've gone a little off course! You're trying to request a locked resource.</p>

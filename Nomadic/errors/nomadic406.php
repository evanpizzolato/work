            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 406 - Not Acceptable</h1>
                        <p class='errText'>Looks like you've gone a little off course! The requested resource contains unacceptable data.</p>

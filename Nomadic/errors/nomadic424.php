...
$page_title = "424 - Failed Dependency";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 424 - Locked</h1>
                        <p class='errText'>Looks like you've gone a little off course! Your request failed because a previous request failed.</p>

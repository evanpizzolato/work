...
$page_title = "416 - Range Not Satisfiable";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 416 - Range Not Satisfiable</h1>
                        <p class='errText'>Looks like you've gone a little off course! You're requesting a portion of a file the server cannot return.</p>

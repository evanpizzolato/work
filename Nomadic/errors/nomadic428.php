...
$page_title = "428 - Precondition Required";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 428 - Precondition Required</h1>
                        <p class='errText'>Looks like you've gone a little off course! Your request failed because the origin server requires your request to be conditional.</p>

...
$page_title = "417 - Expectation Failed";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 417 - Expectation Failed</h1>
                        <p class='errText'>Looks like you've gone a little off course! The server cannot meet the requirements of the Expect request-header field of your request.</p>

            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 451 - Unavailable For Legal Reasons</h1>
                        <p class='errText'>Looks like you've gone a little off course! We've recieved a legal request to deny access to the resource you're trying to access.</p>

...
$page_title = "412 - Precondition Failed";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 412 - Precondition Failed</h1>
                        <p class='errText'>Looks like you've gone a little off course! The server does not meet a precondition (or preconditions) that you have specified in your request.</p>

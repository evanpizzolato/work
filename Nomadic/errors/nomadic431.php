...
$page_title = "431 - Request Header Fields Too Large";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 431 - Request Header Fields Too Large</h1>
                        <p class='errText'>Looks like you've gone a little off course! Your header fields are too large.</p>

...
$page_title = "429 - Too Many Requests";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 429 - Too Many Requests</h1>
                        <p class='errText'>Looks like you've gone a little off course! You've sent too many requests to the server.</p>

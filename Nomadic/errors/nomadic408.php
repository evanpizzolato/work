...
$page_title = "408 - Request Timeout";
            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 408 - Request Timeout</h1>
                        <p class='errText'>Sorry, the server timed out while waiting for your request.</p>

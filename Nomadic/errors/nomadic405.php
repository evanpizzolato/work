            ...
            <div class='jumbotron'>
                <div class='row'>
                    <div class='col-sm-12 text-center'>
                        <h1 class='errTitle'>Oops! Error 405 - Method Not Allowed</h1>
                        <p class='errText'>Looks like you've gone a little off course! You're using an invalid request method to access a resource.</p>
